...
public class FetchService extends IntentService
{
    ...
    {
        int timeframe = MainActivity.NUM_DAYS / 2;
        getData("n" + timeframe);
        getData("p" + timeframe);

        Intent updateWidgetsIntent = new Intent();
        updateWidgetsIntent.setAction(ScoresWidgetProvider.ACTION_DATA_UPDATE);
        getApplicationContext().sendBroadcast(updateWidgetsIntent);
    }
